...
public class HojaSprites {
	...
	public HojaSprites(final String ruta, final int tamañoSprites,
	...
	public HojaSprites(final String ruta, final int anchoSprites,
			final int altoSprites, final boolean hojaOpaca) {
		...
		for (int y = 0; y < altoHojaEnSprites; y++) {
			for (int x = 0; x < anchoHojaEnSprites; x++) {
				...
				sprites[x + y * anchoHojaEnSprites] = new Sprite(
						imagen.getSubimage(posicionX, posicionY, anchoSprites,
								altoSprites));
			}
		}
	}
